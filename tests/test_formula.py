...
from fiba_inbounder.formulas import update_xy_v7, update_stats_v7, update_zone, update_range, update_lineup
...
starter_dict = {
    'T_65245': {'TeamTag': 'TA', 'Starters': {'P_205482', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}},
    'T_57840': {'TeamTag': 'TB', 'Starters': {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}}
}
...
def test_update_lineup():
    ...
    assert sample_dict[0]['TA'] == {'P_205482', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[0]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    assert sample_dict[10]['TA'] == {'P_205482', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[10]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    
    assert sample_dict[52]['TA'] == {'P_205482', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[52]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    assert sample_dict[53]['TA'] == {'P_205482', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[53]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    
    assert sample_dict[54]['TA'] == {'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[54]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    assert sample_dict[55]['TA'] == {'P_224342', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[55]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    
    assert sample_dict[64]['TA'] == {'P_224342', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[64]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    assert sample_dict[65]['TA'] == {'P_224342', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[65]['TB'] == {'P_272277', 'P_185988', 'P_188667', 'P_258737', 'P_205412'}
    
    assert sample_dict[66]['TA'] == {'P_224342', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[66]['TB'] == {'P_272277', 'P_185988', 'P_258737', 'P_205412'}
    
    assert sample_dict[67]['TA'] == {'P_224342', 'P_224350', 'P_206446', 'P_194018', 'P_199054'}
    assert sample_dict[67]['TB'] == {'P_272277', 'P_185988', 'P_258737', 'P_205412', 'P_210544'}
